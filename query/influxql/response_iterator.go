...
// NewResponseIterator constructs a ResponseIterator from a Response.
func NewResponseIterator(r *Response) *ResponseIterator {
...
// queryResult is a simple wrapper for Result that implements query.Result and query.TableIterator.
type queryResult struct {
	result *Result
}

func newQueryResult(r *Result) *queryResult {
	return &queryResult{
		result: r,
	}
}
...
func (r *queryResult) Name() string {
	return fmt.Sprintf("%d", r.result.StatementID)
}

// Tables returns the original as a query.TableIterator.
// It is used to implement query.Result.
func (r *queryResult) Tables() query.TableIterator {
	return r
}

// Do iterates through the series of a Result.
// It is used to implement query.TableIterator.
func (r *queryResult) Do(f func(query.Table) error) error {
